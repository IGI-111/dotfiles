...
if beautiful.wallpaper then
    for s = 1, screen.count() do
        gears.wallpaper.maximized(beautiful.wallpaper, s, "#e5e5e5")
    end
end
-- }}}
...
volume.bar:buttons (awful.util.table.join (
          awful.button ({}, 1, function()
			...
			awful.util.spawn("amixer set Front toggle")
          end),
...
-- Redshift widget
icons_dir = os.getenv("HOME") .. "/.config/awesome/redshift/"
local rs_on = icons_dir .. "redshift_on.png"
local rs_off = icons_dir .. "redshift_off.png"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "Return", function () awful.util.spawn(editor) end),
    awful.key({ modkey, "Mod1"     }, "Return", function () awful.util.spawn(fileManager) end),
...
-- run_once("compton -fc &")
run_once("skype")
run_once("sh -c 'STEAM_FRAME_FORCE_CLOSE=1 steam -silent' %U")
-- }}}
